...
### Задание 1 +
Создать базу данных «Музыкальный магазин», состоящую их трёх таблиц: «Исполнитель», «Альбом», «Композиция». 
Поля каждой сущности: «Исполнитель» (имя), «Альбом» (название, жанр), «Композиция» (название, длительность).   
...
### Задание 3
Используя JDBC, подключиться к БД, созданной в задании №1. 
...
а также добавление, удаление и редактирование данных в одной из таблиц.
